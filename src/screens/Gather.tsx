        ...
        {step === 0 && (
          <div className="card p-6 space-y-4">
            ...
            <Alert tone="info" title="معلومات المجموعة">
              <div className="mt-1 flex flex-wrap gap-3 text-xs"><span>الاسم: @market_sa</span><span>النوع: عام</span><span>الأعضاء: 15,340</span></div>
            </Alert>
        ...
        {step === 4 && (
          <div className="card p-6">
            ...
            <div className="mb-4 grid gap-2 text-sm sm:grid-cols-2">
              ...
              <SRow label="الحد"     value="جميع المتاحين" />
              <SRow label="الحساب"   value="تدوير" />
            </div>
            {!running && progress === 0 && <Button variant="primary" className="w-full" icon={<Play className="h-4 w-4" />} onClick={start}>بدء التجميع</Button>}
            {(running || progress > 0) && progress < 100 && (
              <div>
                ...
                <div className="mt-3 grid grid-cols-3 gap-2 text-center text-xs text-surface-500">
            ...
            {progress === 100 && (
              <div className="space-y-3">
                <Alert tone="success" title="اكتمل! المستخرج: 15,340 | الوقت: 4د" />
    ...
    <div className="animate-fade">
      ...
      <div className="card p-5">
        ...
        <div className="mt-4">
          ...
          {done && <Alert tone="success" title="اكتمل | إجمالي: 29,521 | مكرر أُزيل: 1,200">تم إرسال الملف المدمج.</Alert>}
          {done && <Button className="mt-3" onClick={() => push(["gather"])}>رجوع</Button>}
        </div>
      </div>
      {node}
    </div>
